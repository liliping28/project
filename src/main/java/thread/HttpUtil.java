...
public class HttpUtil {
     ...
     * @return
     */
    public static String post(String url, Map<String, String> params,String authorization) {
    	log.info("post"+url);
        String res = null;
        CloseableHttpClient httpClient = HttpClients.createDefault();
        try {
     ...
     * @return
     */
    public static String postJson(String url, String jsonStr,String referer) {
        log.info("post"+url);
        String res = null;
        CloseableHttpClient httpClient = HttpClients.createDefault();
        try {
...
//            -d '{"conf":"{\"key\":\"value\"}"}'
            ...
            httpPost.setHeader("Authorization", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6ImdjbiIsInBhc3N3b3JkIjoiMTIzNDU2IiwiZXhwIjoxNTc1ODExODgyLCJuYmYiOjE1NzU3MjU0ODJ9.A9TWR1QyJY3R8_lTt1VK1GJEOuCIpAjhRua1nnq6eHQ");
